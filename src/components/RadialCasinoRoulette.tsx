  ...
  const getPool = (stage: SpinStage): GenericRouletteItem[] => {
    ...
    if (currentPoolStage === 'ability') {
      ...
      return [
        ...
        { id: 'double', name: 'Double Combo', categoryOrMode: 'ABILITY', iconPath: assetPath('/assets/images/uses-2.webp') },
        { id: 'triple', name: 'Triple Combo', categoryOrMode: 'ABILITY', iconPath: assetPath('/assets/images/uses-1.webp') },
        { id: 'all', name: 'Full Utility', categoryOrMode: 'ABILITY', iconPath: assetPath('/assets/images/uses-2.webp') },
      ];
    }
